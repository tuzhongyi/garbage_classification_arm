...
export interface DeviceSortationCalibrationMessageReceiverEvent {
  save_result(args: ResultArgs): void
}
export interface DeviceSortationCalibrationMessageSenderEvent {
...
export class DeviceSortationCalibrationMessage
  implements DeviceSortationCalibrationMessageSenderEvent
{
  ...
  private client = new EventMessageClient<
    DeviceSortationCalibrationMessageSenderEvent,
    DeviceSortationCalibrationMessageReceiverEvent
  >(['save_confirm'])
  private reigst() {
