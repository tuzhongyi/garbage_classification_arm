...
export interface DeviceSortationPlayMessageReceiverEvent {
  save_result(args: ResultArgs): void
}
export interface DeviceSortationPlayMessageSenderEvent {
...
export class DeviceSortationPlayMessage
  implements DeviceSortationPlayMessageSenderEvent
{
  ...
  private client = new EventMessageClient<
    DeviceSortationPlayMessageSenderEvent,
    DeviceSortationPlayMessageReceiverEvent
  >(['save_confirm'])
  private reigst() {
