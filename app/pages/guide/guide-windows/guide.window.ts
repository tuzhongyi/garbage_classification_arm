...
import {
  GuideWindowMessageEvent,
  GuideWindowMessageResponseEvent,
} from '../guide.event'

export class ArmGuideWindow {
  constructor() {
    this.regist()
  }
  ...
  message: EventMessageProxy<GuideWindowMessageResponseEvent> =
    new EventMessageProxy(this.iframe)
  event: EventEmitter<GuideWindowMessageEvent> = new EventEmitter()
