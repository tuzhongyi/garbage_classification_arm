...
export interface DeviceSortationListMessageReceiverEvent {
  details_result(result: ResultArgs): void
  delete_result(result: ResultArgs): void
}
export interface DeviceSortationListMessageSenderEvent {
  info(id: string): void
...
export class DeviceSortationListMessage
  implements DeviceSortationListMessageSenderEvent
{
