...
export interface AIEventDeploymentSheetCloneEvent {
  copy(weeks: number[]): void
}
export class AIEventDeploymentSheetCloneController {
  event = new EventEmitter<AIEventDeploymentSheetCloneEvent>()
  constructor() {
    this.regist()
  }
